...
mixin _$FinanceCategory {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, color, kind, notes, created, updated);

  @override
  String toString() {
    return 'FinanceCategory(id: $id, name: $name, color: $color, kind: $kind, notes: $notes, created: $created, updated: $updated)';
  }
}
