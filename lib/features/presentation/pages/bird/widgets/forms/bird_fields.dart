        ...
        children: [
          ...
          BirdTextField(
            ...
            onChanged: (fatherRingnumber) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(
                      bird: bird.copyWith(fatherRingnumber: fatherRingnumber),
                    ),
                  );
            },
          ),
          BirdTextField(
            ...
            onChanged: (motherRingnumber) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(
                      bird: bird.copyWith(motherRingnumber: motherRingnumber),
                    ),
                  );
            },
          ),
          BirdDropdownField<Origin>(
            ...
            onChanged: (origin) {
              context
                  .read<BirdBloc>()
                  .add(BirdEvent.change(bird: bird.copyWith(origin: origin)));
            },
            items: Origin.values
                .map(
                  (e) => DropdownMenuItem(
          ...
          BirdDateField(
            ...
            onChanged: (bornDate) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(bird: bird.copyWith(bornDate: bornDate)),
                  );
            },
          ),
          BirdDateField(
          ...
          BirdDateField(
            ...
            onChanged: (sellDate) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(bird: bird.copyWith(sellDate: sellDate)),
                  );
            },
          ),
          BirdDateField(
            ...
            onChanged: (diedDate) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(bird: bird.copyWith(diedDate: diedDate)),
                  );
            },
          ),
          BirdTextField(
          ...
          BirdTextField(
            ...
            onChanged: (partnerRingnumber) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(
                      bird: bird.copyWith(partnerRingnumber: partnerRingnumber),
                    ),
                  );
            },
          ),
          BirdDropdownField<Species>(
            ...
            onChanged: (species) {
              context
                  .read<BirdBloc>()
                  .add(BirdEvent.change(bird: bird.copyWith(species: species)));
            },
            items: const [],
          ),
          ...
          BirdDropdownField<bool>(
            ...
            onChanged: (isForSale) {
              context.read<BirdBloc>().add(
                    BirdEvent.change(bird: bird.copyWith(isForSale: isForSale)),
                  );
            },
            items: const [],
          ),
