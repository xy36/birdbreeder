...
class _$BirdDtoImpl with Timestamp implements _BirdDto {
  ...
  @override
  String toString() {
    return 'BirdDto(id: $id, ringnumber: $ringnumber, speciesId: $speciesId, colorId: $colorId, cageId: $cageId, sex: $sex, origin: $origin, bornDate: $bornDate, diedDate: $diedDate, boughtDate: $boughtDate, sellDate: $sellDate, boughtPrice: $boughtPrice, sellPriceOffer: $sellPriceOffer, sellPriceReal: $sellPriceReal, fatherRingnumber: $fatherRingnumber, motherRingnumber: $motherRingnumber, partnerRingnumber: $partnerRingnumber, isForSale: $isForSale)';
  }
