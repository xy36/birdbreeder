...
import 'package:birdbreeder/features/cages/presentation/cage/widgets/delete_cage_button.dart';
        ...
        actions: [
          IconButton(
            onPressed: () {
              if (isValid) {
                isEdit
                    ? context.read<CageCubit>().edit(_cage!)
                    : context.read<CageCubit>().add(_cage!);
