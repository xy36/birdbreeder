...
/// {@template package:birdbreeder/features/ressourcen_center/domain/mapper/cage_mapper.dart}
/// Available mappings:
/// - `Cage` → `CageDto`.
/// - `CageDto` → `Cage`.
/// {@endtemplate}
class $CageMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/features/ressourcen_center/domain/mapper/cage_mapper.dart}
  @override
