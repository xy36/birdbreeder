...
/// {@template package:birdbreeder/features/ressourcen_center/domain/mapper/species_mapper.dart}
/// Available mappings:
/// - `Species` → `SpeciesDto`.
/// - `SpeciesDto` → `Species`.
/// {@endtemplate}
class $SpeciesMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/features/ressourcen_center/domain/mapper/species_mapper.dart}
  @override
