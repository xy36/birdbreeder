...
extension BirdBreederSubscriptionExtension on BirdBreederCubit {
  ...
  void unsubscribeFromCages() {
    unawaited(s1.get<PocketBaseService>().cagesCollection.unsubscribe());
  }
  ...
  void unsubscribeFromColors() {
    unawaited(s1.get<PocketBaseService>().colorsCollection.unsubscribe());
  }
            ...
            case 'update':
              emitLoaded(
                contacts: state.birdBreederResources.contacts
                    .map(
                      (e) =>
                          e.id == contact.id ? resolveContactDto(contact) : e,
                    )
                    .toList(),
              );
            case 'create':
  ...
  void unsubscribeFromContacts() {
    unawaited(s1.get<PocketBaseService>().contactsCollection.unsubscribe());
  }
            ...
            case 'update':
              emitLoaded(
                species: state.birdBreederResources.species
                    .map(
                      (e) =>
                          e.id == species.id ? resolveSpeciesDto(species) : e,
                    )
                    .toList(),
              );
  ...
  void unsubscribeFromSpecies() {
    unawaited(s1.get<PocketBaseService>().speciesCollection.unsubscribe());
  }
  ...
  void unsubscribeFromBreedingPairs() {
    unawaited(s1.get<PocketBaseService>().breedingPairCollection.unsubscribe());
  }
  ...
  void unsubscribeFromBirds() {
    unawaited(s1.get<PocketBaseService>().birdsCollection.unsubscribe());
  }
  ...
  void unsubscribeFromBroods() {
    unawaited(s1.get<PocketBaseService>().broodsCollection.unsubscribe());
  }
  ...
  void unsubscribeFromEggs() {
    unawaited(s1.get<PocketBaseService>().eggsCollection.unsubscribe());
  }
      ...
      s1.get<PocketBaseService>().financesCategoriesCollection.subscribe(
        ...
        (e) {
          ...
          switch (e.action) {
            ...
            case 'delete':
              emitLoaded(
                financesCategories: state
                    .birdBreederResources.financesCategories
                    .where((e) => e.id != cat.id)
                    .toList(),
              );
          }
  ...
  void unsubscribeFromFinances() {
    unawaited(s1.get<PocketBaseService>().financesCollection.unsubscribe());
  }
}
