...
abstract class IRepository {
  ...
  /// Update the bird
  Future<Result<void>> updateBird(Bird bird);

  /// Create a new bird.
  Future<Result<void>> createBird(Bird bird);

  /// Species

  /// Create a new species.
  Future<Result<void>> createSpecies(Species species);
  ...
  /// Update the species
  Future<Result<void>> updateSpecies(Species species);
  ...
  /// Create a new cage.
  Future<Result<void>> createCage(Cage cage);
  ...
  /// Updates the cage.
  Future<Result<void>> updateCage(Cage cage);
  ...
  /// Create a new color.
  Future<Result<void>> createColor(BirdColor color);
  ...
  /// Updates the color.
  Future<Result<void>> updateColor(BirdColor color);
}
