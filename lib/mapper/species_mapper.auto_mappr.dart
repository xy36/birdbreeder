...
import 'package:birdbreeder/models/ressources/dto/species_dto.dart' as _i3;
import 'package:birdbreeder/models/ressources/entity/species.dart' as _i2;

/// {@template package:birdbreeder/mapper/species_mapper.dart}
/// Available mappings:
/// - `Species` → `SpeciesDto`.
/// - `SpeciesDto` → `Species`.
/// {@endtemplate}
class $SpeciesMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/species_mapper.dart}
  @override
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    ...
    if ((sourceTypeOf == _typeOf<_i3.SpeciesDto>() ||
            sourceTypeOf == _typeOf<_i3.SpeciesDto?>()) &&
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i3.SpeciesDto>() ||
      ...
      return (_map__i3$SpeciesDto_To__i2$Species((model as _i3.SpeciesDto?))
          as TARGET);
    }
  ...
  _i2.Species _map__i3$SpeciesDto_To__i2$Species(_i3.SpeciesDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
