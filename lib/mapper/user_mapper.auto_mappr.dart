...
import 'package:birdbreeder/models/authentication/dtos/user_dto.dart' as _i2;
import 'package:birdbreeder/models/authentication/entity/user.dart' as _i3;

/// {@template package:birdbreeder/mapper/user_mapper.dart}
/// Available mappings:
/// - `UserDto` → `User`.
/// - `User` → `UserDto`.
/// {@endtemplate}
class $UserMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/user_mapper.dart}
  @override
