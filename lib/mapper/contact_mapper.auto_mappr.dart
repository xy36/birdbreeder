...
import 'package:birdbreeder/models/contact/dtos/contact_dto.dart' as _i3;
import 'package:birdbreeder/models/contact/entity/contact.dart' as _i2;

/// {@template package:birdbreeder/mapper/contact_mapper.dart}
/// Available mappings:
/// - `Contact` → `ContactDto`.
/// - `ContactDto` → `Contact`.
/// {@endtemplate}
class $ContactMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/contact_mapper.dart}
  @override
