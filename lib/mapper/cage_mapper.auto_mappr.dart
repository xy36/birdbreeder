...
import 'package:birdbreeder/models/ressources/dto/cage_dto.dart' as _i3;
import 'package:birdbreeder/models/ressources/entity/cage.dart' as _i2;

/// {@template package:birdbreeder/mapper/cage_mapper.dart}
/// Available mappings:
/// - `Cage` → `CageDto`.
/// - `CageDto` → `Cage`.
/// {@endtemplate}
class $CageMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/cage_mapper.dart}
  @override
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    ...
    if ((sourceTypeOf == _typeOf<_i3.CageDto>() ||
            sourceTypeOf == _typeOf<_i3.CageDto?>()) &&
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i3.CageDto>() ||
      ...
      return (_map__i3$CageDto_To__i2$Cage((model as _i3.CageDto?)) as TARGET);
    }
  ...
  _i2.Cage _map__i3$CageDto_To__i2$Cage(_i3.CageDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
