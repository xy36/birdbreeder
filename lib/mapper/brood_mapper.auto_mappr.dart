...
import 'package:birdbreeder/models/breeding/dtos/brood_dto.dart' as _i3;
import 'package:birdbreeder/models/breeding/entity/brood.dart' as _i2;

/// {@template package:birdbreeder/mapper/brood_mapper.dart}
/// Available mappings:
/// - `Brood` → `BroodDto`.
/// - `BroodDto` → `Brood`.
/// {@endtemplate}
class $BroodMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/brood_mapper.dart}
  @override
  ...
  _i3.BroodDto _map__i2$Brood_To__i3$BroodDto(_i2.Brood? input) {
    final model = input;
    if (model == null) {
      throw Exception(
          r'Mapping Brood → BroodDto failed because Brood was null, and no default value was provided. '
          r'Consider setting the whenSourceIsNull parameter on the MapType<Brood, BroodDto> to handle null values during mapping.');
    }
    return _i3.BroodDto(
      id: model.id,
      start: model.start,
