...
class $BirdColorMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/bird_color_mapper.dart}
  @override
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    ...
    if ((sourceTypeOf == _typeOf<_i3.BirdColorDto>() ||
            sourceTypeOf == _typeOf<_i3.BirdColorDto?>()) &&
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<_i3.BirdColorDto>() ||
      ...
      return (_map__i3$BirdColorDto_To__i2$BirdColor(
          (model as _i3.BirdColorDto?)) as TARGET);
    }
  ...
  _i2.BirdColor _map__i3$BirdColorDto_To__i2$BirdColor(
      _i3.BirdColorDto? input) {
    final model = input;
    if (model == null) {
      throw Exception(
