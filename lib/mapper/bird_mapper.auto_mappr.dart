...
import 'package:birdbreeder/models/bird/dtos/bird_dto.dart' as _i3;
import 'package:birdbreeder/models/bird/entity/bird.dart' as _i2;

/// {@template package:birdbreeder/mapper/bird_mapper.dart}
/// Available mappings:
/// - `Bird` → `BirdDto`.
/// - `BirdDto` → `Bird`.
/// {@endtemplate}
class $BirdMapper implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:birdbreeder/mapper/bird_mapper.dart}
  @override
